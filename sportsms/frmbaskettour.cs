...
namespace sportsms
{
    public partial class frmbaskettour : Form
    {
        ...
        SqlDataReader dr;
        public frmbaskettour()
        {
            InitializeComponent();
        }

        private void frmbaskettour_Load(object sender, EventArgs e)
        {
            cmd.Connection = cn;
            loadgrid();
        }
        private void loadgrid()
        {
            ...
            cn.Open();
            cmd.CommandText = "select * from tbl_tour where (tournament = N'BASKETBALL')";
            int i;
            i = 0;
            //Do While Not rs.EOF
