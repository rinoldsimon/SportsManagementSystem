...
namespace sportsms
{
    public partial class frmvophotos : Form
    {
        ...
        private void frmvophotos_Load(object sender, EventArgs e)
        {
            cmd.Connection = cn;
            loadgrid();
        }
        private void loadgrid()
        {
            ...
            cn.Open();
            cmd.CommandText = "select * from tbl_volley";
            int i;
            i = 0;
            //Do While Not rs.EOF
...
txtphoto.Text = DataGridView1.CurrentRow.Cells[0].Value.ToString();
        ...
        private void Button2_Click_1(object sender, EventArgs e)
        {
            ...
            {
                string q = "insert into tbl_volley(photo) values('" + txtphoto.Text + "')";
                dosomething(q);
        ...
        {
            string q = "delete from tbl_volley where photo='" + DataGridView1.CurrentRow.Cells[0].Value + "'";
            dosomething(q);
