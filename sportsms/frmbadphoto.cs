...
namespace sportsms
{
    public partial class frmbadphoto : Form
    {
        ...
        private void frmbadphoto_Load(object sender, EventArgs e)
        {
            cmd.Connection = cn;
            loadgrid();
        }
        private void loadgrid()
        {
            ...
            cn.Open();
            cmd.CommandText = "select * from tbl_badminton";
            int i;
            i = 0;
            //Do While Not rs.EOF
        ...
        private void Button2_Click_1(object sender, EventArgs e)
        {
            ...
            {
                string q = "insert into tbl_badminton(photo) values('" + txtphoto.Text + "')";
                dosomething(q);
        ...
        {
            string q = "delete from tbl_badminton where photo='" + DataGridView1.CurrentRow.Cells[0].Value + "'";
            dosomething(q);
