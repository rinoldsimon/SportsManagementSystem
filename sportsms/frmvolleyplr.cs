...
namespace sportsms
{
    public partial class frmvolleyplr : Form
    {
        ...
        private void frmvolleyplr_Load(object sender, EventArgs e)
        {
            cmd.Connection = cn;
            loadgrid();
        }
        private void loadgrid()
        {
            ...
            cn.Open();
            cmd.CommandText = "select * from tbl_streg where (sport = N'VOLLEYBALL')";
            int i;
            i = 0;
            //Do While Not rs.EOF
