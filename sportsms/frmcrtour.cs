...
namespace sportsms
{
    public partial class frmcrtour : Form
    {
        ...
        private void frmcrtour_Load(object sender, EventArgs e)
        {
            cmd.Connection = cn;
            loadgrid();
        }
        private void loadgrid()
        {
            ...
            cn.Open();
            cmd.CommandText = "select * from tbl_tour where (tournament = N'CRICKET')";
            int i;
            i = 0;
            //Do While Not rs.EOF
