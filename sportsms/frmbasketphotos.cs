...
namespace sportsms
{
    public partial class frmbasketphotos : Form
    {
        ...
        SqlDataReader dr;
        public frmbasketphotos()
        {
            InitializeComponent();
        }

        private void frmbasketphotos_Load(object sender, EventArgs e)
        {
            cmd.Connection = cn;
            loadgrid();
        }
        private void loadgrid()
        {
            ...
            cn.Open();
            cmd.CommandText = "select * from tbl_basket";
            int i;
            i = 0;
            //Do While Not rs.EOF
        ...
        private void Button2_Click(object sender, EventArgs e)
       {
            ...
            {
                string q = "insert into tbl_basket(photo) values('" + txtphoto.Text + "')";
                dosomething(q);
        ...
        {
            string q = "delete from tbl_basket where photo='" + DataGridView1.CurrentRow.Cells[0].Value + "'";
            dosomething(q);
